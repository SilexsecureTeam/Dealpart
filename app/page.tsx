...
export default function LandingPage() {
        ...
        <div className="container mx-auto px-5 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            <div className="relative rounded-xl overflow-hidden shadow-2xl group h-[500px] lg:h-[600px]">
              <Image src="/offer.jpg" alt="Solar Panels" fill className="object-cover group-hover:scale-105 transition duration-700" />
              <div className="absolute inset-0 bg-gradient-to-r from-[#023337]/90 via-[#023337]/50 to-transparent" />
              <div className="absolute bottom-0 left-0 p-8 md:p-12 text-white">
                <h3 className="text-4xl md:text-5xl lg:text-6xl font-black mb-3">Solar Panels</h3>
            ...
            <div className="grid grid-rows-2 gap-6 lg:gap-8">
              <div className="relative rounded-xl overflow-hidden shadow-xl group">
                <Image src="/offer.jpg" alt="Inverters" fill className="object-cover group-hover:scale-105 transition duration-700" />
                <div className="absolute inset-0 bg-gradient-to-r from-[#023337]/90 via-[#023337]/50 to-transparent" />
                <div className="absolute bottom-0 left-0 p-6 md:p-8 text-white">
                  <h3 className="text-3xl md:text-4xl font-black mb-3">Inverters</h3>
              ...
              <div className="grid grid-cols-2 gap-6">
                {["Charge Controllers", "Batteries"].map((title) => (
                  <div key={title} className="relative rounded-xl overflow-hidden shadow-xl group aspect-square">
                    <Image src="/offer.jpg" alt={title} fill className="object-cover group-hover:scale-105 transition duration-700" />
                    <div className="absolute inset-0 bg-gradient-to-r from-[#023337]/90 via-[#023337]/50 to-transparent" />
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white">
        <div className="container mx-auto px-5 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-8 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-[#023337]">The Best Offers</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5 sm:gap-7 lg:gap-8">
            {[
              { id: 1, name: "Apex 550W Monocrystalline Panel", price: "₦29.99", rating: 5, stock: "In stock", image: "/offer.jpg" },
              { id: 2, name: "Lithium LiFePO4 Battery 12V / 100Ah", price: "₦40.99", rating: 5, stock: "Only 4 left", image: "/offer.jpg" },
              { id: 3, name: "Solar Motion Sensor Light (24W)", price: "₦119.99", rating: 5, stock: "In stock", image: "/offer.jpg" },
              { id: 4, name: "MPPT Charge Controller 60A", price: "₦119.99", rating: 5, stock: "In stock", image: "/offer.jpg" },
            ].map((p) => {
              const priceVal = toNumberPrice(p.price);
              return (
                  ...
                  <div className="p-4 md:p-5">
                    ...
                    <div className="flex mb-2">
                      {Array(5).fill(0).map((_, i) => (
                        <Star key={i} className={`w-4 h-4 ${i < p.rating ? "fill-yellow-400 text-yellow-400" : "text-gray-300"}`} />
                      ))}
                    </div>
                    <p className={`text-sm font-bold mb-3 ${p.stock.includes("left") ? "text-red-600" : "text-green-600"}`}>{p.stock}</p>
                    <p className="text-xl md:text-2xl font-black text-[#4EA674] mb-4">{p.price}</p>
              ...
              {["PV Solar Panels", "Inverters", "Batteries", "Charge Controllers", "Stabilizers", "Accessories"].map((cat) => (
                <div key={cat} className="group cursor-pointer">
                  <div className="relative aspect-[4/3] rounded-xl overflow-hidden shadow-md hover:shadow-xl transition">
                    <Image src="/solarpanel.png" alt={cat} fill className="object-cover group-hover:scale-110 transition duration-500" />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent" />
                    <p className="absolute bottom-4 left-4 right-4 text-white font-bold text-sm md:text-base text-center">{cat}</p>
                  </div>
                </div>
              ))}
            </div>
  ...
  <div className="container mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-8">
      {[
        { id: 101, name: "Apex $50W Monocrystalline Panel", teaser: "This is a brief product description", price: "₦29.99", rating: 5, stock: "In stock", image: "/solarpanel.png", featured: true },
        { id: 102, name: "Lithium LiFePO4 Battery 12V / 100Ah", teaser: "Upgrade your energy storage with safe, long-life lithium technology...", price: "₦40.99", rating: 5, stock: "In stock", hot: true },
        { id: 103, name: "Solar Motion Sensor Light (24z)", teaser: "Upgrade your energy storage with smart, energy-saving motion lighting...", price: "₦119.99", rating: 5, stock: "In stock", hot: true },
        { id: 104, name: "MPPT Charge Controller 60A", teaser: "Upgrade your energy storage with maximum power point tracking efficiency...", price: "₦119.99", rating: 5, stock: "In stock", hot: true },
      ].map(p => {
        const priceVal = toNumberPrice(p.price);
        ...
        return (
          <div
            ...
            className={`rounded-xl shadow-md hover:shadow-xl transition hover:-translate-y-1 overflow-hidden flex flex-col ${
              p.featured ? "bg-gradient-to-br from-[#EAF8E7] to-[#21C45D]" : "bg-white"
            }`}
          >
            <div className="relative aspect-[4/3] overflow-hidden">
              <Image src={p.image || "/offer.jpg"} alt={p.name} fill className="object-cover group-hover:scale-105 transition duration-500" />
              {p.hot && <span className="absolute top-3 left-3 bg-red-500 text-white px-3 py-1 rounded-full text-xs font-bold">Hot</span>}
            ...
            <div className="p-4 sm:p-5">
              ...
              <p className="text-sm text-gray-600 mb-2 line-clamp-2">{p.teaser}</p>
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <span className={`text-sm font-bold ${p.stock.includes("left") ? "text-red-600" : "text-green-600"}`}>
                  {p.stock}
                </span>
              </div>

              <p className="text-xl sm:text-2xl font-black text-[#4EA674] mb-4">{p.price}</p>
        ...
        <div className="container mx-auto px-5 sm:px-6 lg:px-8">
          <div className="relative mb-12">
            <div className="max-w-3xl lg:max-w-4xl mx-auto">
              <Image src="/solarpanel.png" alt="Rilsopower" width={800} height={800} className="object-contain drop-shadow-2xl mx-auto" priority />
            </div>
            <div className="mt-8 text-center lg:absolute lg:top-10 lg:right-10 lg:mt-0 lg:text-right lg:max-w-md">
              <h2 className="text-3xl md:text-5xl font-black text-gray-900 mb-4">Rilsopower Stabilizers</h2>
              <p className="text-lg md:text-xl text-gray-700 mb-6">Best automatic voltage regulators</p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 md:gap-6">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="bg-white rounded-xl shadow-md p-4 text-center hover:shadow-xl transition">
                ...
                <div className="flex justify-center mb-1">
                  {Array(5).fill(0).map((_, s) => <Star key={s} className="w-3.5 h-3.5 fill-yellow-400" />)}
                </div>
  ...
  <div className="grid grid-cols-1 lg:grid-cols-5 xl:grid-cols-6 gap-6 lg:gap-8 xl:gap-10">
    {/* Left - Large promo banner – takes most width */}
    <div className="lg:col-span-3 xl:col-span-4 relative rounded-2xl overflow-hidden shadow-2xl min-h-[400px] sm:min-h-[450px] md:min-h-[500px] lg:min-h-[560px] xl:min-h-[620px] group order-2 lg:order-1">
      ...
      {/* Tilted solar panel image – positioned left */}
      ...
      {/* Text – right aligned, more breathing room */}
    ...
    {/* Right – Featured product card – narrower */}
      ...
      <div className="p-5 sm:p-6 lg:p-7 flex flex-col flex-grow">
        ...
        <div className="mt-auto flex flex-col sm:flex-row gap-4">
          ...
          <div className="mt-12 md:mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { name: "Dry Cell", gradient: "from-[#7D0707] via-[#B00707] to-[#CA0808]", textColor: "text-red-700" },
              { name: "Gel", gradient: "from-[#ECCB0F] via-[#E6C000] to-[#FBBD23]", textColor: "text-yellow-700" },
              { name: "Tubular", gradient: "from-[#000000] to-[#023337]", textColor: "text-green-800" },
            ].map((t) => (
              <div key={t.name} className="relative rounded-xl overflow-hidden h-80 md:h-96 group shadow-2xl">
                ...
                <div className="absolute inset-0 flex items-center justify-end pr-10 md:pr-16">
                  <div className="relative w-1/2 md:w-2/5 h-5/6">
                    <Image src="/solarpanel.png" alt={`${t.name} Batteries`} fill className="object-contain object-right group-hover:scale-105 transition duration-700" />
                  </div>
                </div>
                <div className="relative z-10 h-full flex items-center pl-10 md:pl-16">
                  <div className="text-left max-w-[55%]">
                    <h3 className="text-3xl md:text-4xl font-black text-white mb-4 drop-shadow-lg">{t.name}</h3>
                    <p className="text-lg md:text-xl text-white/90 mb-6">{t.name} Batteries</p>
                    <button className={`px-6 py-4 bg-white ${t.textColor} font-bold rounded-full hover:bg-gray-100 transition text-lg`}>
                      View Details
                    </button>
                  </div>
                </div>
