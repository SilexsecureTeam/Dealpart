  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex">
      <div className="lg:ml-64 w-full">
        {/* Header */}
        <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 sm:px-6 lg:px-8 py-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="relative hidden md:block">
              ...
              <input
                ...
                className="pl-12 pr-6 py-3.5 bg-gray-100 dark:bg-gray-700 rounded-full text-sm w-72 lg:w-96 focus:outline-none focus:ring-2 focus:ring-[#646FF2]/30"
              />
            </div>
            ...
            >
              <Sun className={`w-5 h-5 text-yellow-500 transition-opacity ${isDarkMode ? "opacity-0" : "opacity-100"} absolute inset-0 m-auto`} />
              <Moon className={`w-5 h-5 text-blue-400 transition-opacity ${isDarkMode ? "opacity-100" : "opacity-0"} absolute inset-0 m-auto`} />
            </button>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm">
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <p className="text-sm text-[#7C7C7C] mt-1">Last 7 days</p>
                </div>
              ...
              <div className="mb-6">
                <div className="flex items-end gap-4">
                  ...
                  <p className="text-lg font-bold text-[#4EA674] flex items-center gap-1 pb-1">Sales ↑ 10.4%</p>
                </div>
                <p className="text-sm text-[#7C7C7C] mt-2">Previous 7days ($235)</p>
              </div>
              <button className="w-full py-3 border border-[#4EA674] text-[#4EA674] rounded-full text-sm font-bold hover:bg-gradient-to-r hover:from-[#4EA674] hover:to-[#4EA674] hover:text-white transition-all">
                Details
              </button>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm">
              ...
              <div className="mb-6">
                <div className="flex items-end gap-4">
                  ...
                  <p className="text-lg font-bold text-[#4EA674] flex items-center gap-1 pb-1">order ↑ 14.4%</p>
                </div>
                <p className="text-sm text-[#7C7C7C] mt-2">Previous 7days (7.6k)</p>
              </div>
              <button className="w-full py-3 border border-[#4EA674] text-[#4EA674] rounded-full text-sm font-bold hover:bg-gradient-to-r hover:from-[#4EA674] hover:to-[#4EA674] hover:text-white transition-all">
                Details
              </button>
            ...
            <div className="lg:col-span-2 bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                ...
                <div className="flex items-center gap-2">
                  <button className="px-5 py-2.5 bg-[#C1E6BA] text-[#4EA674] rounded-full text-sm font-bold">This week</button>
                  <button className="px-5 py-2.5 bg-[#EAF8E7] text-[#7C7C7C] rounded-full text-sm font-medium hover:bg-[#C1E6BA] hover:text-[#4EA674] transition-colors">Last week</button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 flex flex-col gap-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm">
                ...
                <div className="mt-8">
                  <button className="w-full py-3.5 border-[#4EA674] text-[#4EA674] rounded-full text-sm font-bold hover:bg-gradient-to-r hover:from-[#646FF2] hover:to-[#8B75F6] hover:text-white transition-all">
                    Details
                  </button>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm">
                ...
                <div className="mt-8">
                  <button className="w-full py-3.5 border-[#4EA674] text-[#4EA674] rounded-full text-sm font-bold hover:bg-gradient-to-r hover:from-[#4EA674] hover:to-[#4EA674] hover:text-white transition-all">
                    Details
                  </button>
                </div>
              </div>
            ...
            {/* Right: Top Products + Add New Product */}
            <div className="lg:col-span-4 flex flex-col gap-8">
                ...
                <div className="space-y-5">
                  {topProducts.map((p, i) => (
                    <div key={i} className="flex items-center gap-4">
                      <Image
                        src="/solarpanel.png" alt={p.name} width={64} height={64} className="rounded-lg object-cover flex-shrink-0"
                        unoptimized
                      />
                      ...
                      <p className="font-bold text-[#646FF2] text-lg">{p.price}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <button className="px-4 py-2 border border-[#646FF2] text-[#646FF2] rounded-full text-sm font-medium hover:bg-[#646FF2] hover:text-white transition-colors flex items-center gap-2">
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-3">
                    {["Pv Solar panels", "Inverters", "Batteries"].map((cat) => (
                      <div key={cat} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors cursor-pointer">
                  ...
                  <button className="text-[#646FF2] text-sm font-medium mt-4 block mx-auto hover:underline">See more</button>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {["₦39.99", "₦19.99", "₦34.99"].map((price, i) => (
                      <div key={i} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                        <div className="flex items-center gap-4">
