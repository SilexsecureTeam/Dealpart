          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm">
              <div className="flex justify-between items-center mb-6">
                ...
                <button className="px-4 py-2 border border-[#4EA674] text-[#4EA674] rounded-full text-sm font-medium hover:bg-[#646FF2] hover:text-white transition-colors flex items-center gap-2">
